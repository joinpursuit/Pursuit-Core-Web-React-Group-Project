...
INSERT INTO users (full_name, user_name, email, password, phone_number, profile_pic)
VALUES 
...
INSERT INTO posts (user_id, image, brand, description, release_date, colorway)
VALUES
...
INSERT INTO tags (post_id, user_id, tag)
VALUES
    (1,1,'nike'),
    (2,2,'adidas'),
    (3,3,'tims'),
